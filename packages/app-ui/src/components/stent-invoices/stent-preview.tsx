...
interface StentInvoicePreviewProps {
	selectedInvoice?: StentInvoice;
}

export function StentInvoicePreview({
	selectedInvoice,
}: StentInvoicePreviewProps) {
		...
		return (
			<Card className="flex min-h-0 w-full flex-1 flex-col items-center justify-center">
				<CardContent className="text-center">
					...
					<CardTitle className="mb-2">Stent Invoice Preview</CardTitle>
					<CardDescription>
						Select a stent invoice from the list to preview it here
					</CardDescription>
				</CardContent>
			</Card>
		);
